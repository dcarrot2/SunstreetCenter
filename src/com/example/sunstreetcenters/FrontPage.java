...
SharedPreferences.Editor editor;
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(FrontPage.this).setTitle("Choose your age:").setAdapter(adapter, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch(which){
                		case 0:
                			com.example.sunstreetcenters.FrontPage.age = "9-13";
                			break;
                		case 1:
                			com.example.sunstreetcenters.FrontPage.age = "14-18";
                			break;
                		case 2:
                			com.example.sunstreetcenters.FrontPage.age = "19+";
                			break;
	...
	public void onCheckedChanged(RadioGroup rg1 , int i) {
		...
		if(i==female.getId())
		{
			com.example.sunstreetcenters.FrontPage.choice = "Female";
		}
		
		else if (i==male.getId())
		{
			com.example.sunstreetcenters.FrontPage.choice  = "Male";
		}
